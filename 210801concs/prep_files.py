...
#
CaMKII     = [250,  500, 1000]
GluN2B     = [750, 1500, 3000]
CaMKII_, GluN2B_  = np.meshgrid(CaMKII, GluN2B)
CaMKII_  = CaMKII_.reshape(-1)
GluN2B_  = GluN2B_.reshape(-1)
#
...
qsub_file          = "exe.sh"
#
for i, (CKII,GluN) in enumerate(zip(CaMKII_, GluN2B_)):
    ...
    print(subdir)
    print('CaMKII: ', str(CKII),'; GluN2B: ', str(GluN))
    ...
    data_lines = data_lines.replace("## MC_TEMP ##"    , str(TEMP))
